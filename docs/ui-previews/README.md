...
- **Mobile home = capture compose.** **Desktop home = list at `/app`.**
...
| Mobile home `/app/capture`   | —                                                    | [mobile-capture.svg](./mobile-capture.svg)         |
| Ideas `/app` `/app/list`     | [desktop-board.svg](./desktop-board.svg)             | [mobile-board.svg](./mobile-board.svg)             |
